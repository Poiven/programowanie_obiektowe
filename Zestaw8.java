...
//    private String nazwisko;
    ...
    public Klient(String imie, String nazwisko, ArrayList<Zamowienie> listaZamowien, Adres adresKlienta){
       /* this.imie=imie;
        this.nazwisko=nazwisko;*/
        super(imie, nazwisko);
        this.listaZamowien=listaZamowien;
    ...
    @Override
    public String toString() {
        return "imie: "+this.getImie()+", nazwisko: "+this.getNazwisko()+", listaZamowien: "+listaZamowien +",adresKlienta: "+adresKlienta;
...
abstract class jablko extends owoc{
    public jablko(String nazwa, double cena, int iloscNaMagazynie) {
        super(nazwa, cena, iloscNaMagazynie);
    }
}

abstract class ogorek extends warzywo{
    public ogorek(String nazwa, double cena, int iloscNaMagazynie) {
        super(nazwa, cena, iloscNaMagazynie);
    }
}
